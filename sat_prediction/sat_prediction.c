...
void sat_prediction_update_tles(void) {
    // TODO: Implement HTTP download of TLEs
    // For now, we can use a hardcoded TLE for testing
    const char* tles =
        "SATELIOT_1\n"
        "1 60550U 24149CL  26005.47464907  .00003238  00000+0  28461-3 0  9999\n"
        "2 60550  97.6907  84.0601 0005583 256.9504 103.1095 14.97239077 75715\n"
        "SATELIOT_2\n"
    ...
    LOG_INF("Updating TLEs (using hardcoded data)");
    num_sats = ParseTLEs(tles, sats, MAX_SATS);
    LOG_INF("Loaded %d satellites", num_sats);
}
